...
1. First user to interact becomes admin (or set via database)
2. Use the Admin Settings from the Home tab to create teams
3. Assign managers who can approve requests
...
| `DEFAULT_TIMEZONE` | Default timezone for dates | No | `UTC` |
...
- The app handles this gracefully with user-friendly messages
